...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      let done = false;
      // Se asigna despues de definir finish(), que ya la referencia en su
      // clearTimeout. Reordenarlo para poder usar const cambiaria el orden
      // de ejecucion de codigo de sesion, asi que se silencia la regla.
